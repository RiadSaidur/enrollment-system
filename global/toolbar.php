...
<nav>
  <ul class="menu">
    <li>
      <a class=" <?php if($CURR_PAGE == 'Home') { ?> active <?php } ?>" href="/"><img src="./assets/house.svg" alt="">
        <span> Home</span>
      </a>
    </li>
    <li>
    ...
    <li>
      <a class=" <?php if($CURR_PAGE == 'All Students') { ?> active <?php } ?>" href="./allstudents.php">
        <img src="./assets/address.svg" alt="All">
        <span> All Students</span>
      </a>
    </li>
    <li>
      <a class=" <?php if($CURR_PAGE == 'About') { ?> active <?php } ?>">
        <img src="./assets/information.svg" alt="About">
        <span> About</span>
      </a>
    </li>
  </ul>
